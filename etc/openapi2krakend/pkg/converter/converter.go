...
func Convert(swaggerDirectory string, encoding string, globalTimeout string) models.SimpleConfiguration {
	...
	configuration := models.NewSimpleConfiguration(encoding, globalTimeout)
